...
import MaterialRequestWp from './components/MaterialRequestWp';
import { IMaterialRequestWpProps, IMaterialRequestWpWebPartProps } from './interfaces/IMaterialRequestWpProps';
import MaterialMaterialRequestHOSApprovalForm from './components/MaterialRequestHOSApprovalForm';



export default class MaterialRequestWpWebPart extends BaseClientSideWebPart<IMaterialRequestWpWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IMaterialRequestWpProps> = React.createElement(
      MaterialRequestWp,
      {
